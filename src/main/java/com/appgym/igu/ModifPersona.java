 ...
 * @author nicol
 */
public class ModifPersona extends javax.swing.JFrame {

    Controladora control = null;
    Persona persona = new Persona();
    
    public ModifPersona(int Id) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modificacion Miembro");
        ...
        btnModificar.setForeground(new java.awt.Color(255, 235, 0));
        ...
        Fondo.add(btnModificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 360, 80, 30));
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        control.modificarPersona(persona, dni, nombre, apellido, email, telefono);
        
        mostrarMensaje ("Modificacion realizada correctamente", "Info", "Edicion Exitosa");
    ...
    private void CargarDatosPersona(int Id) {
         //busco la persona en la BD
         persona = control.traerPersona(Id);
         //seteo los valores a esta persona de mi form
         DNIText.setText(String.valueOf(persona.getDni()));
         NombreText.setText(persona.getNombre());
         ApellidoText.setText(persona.getApellido());
         EmailText.setText(persona.getEmail());
         TelefonoText.setText(String.valueOf(persona.getTelefono()));
    }
}
